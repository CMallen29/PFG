  ...
  return (
    <div className="grid grid-cols-3 p-10">
      <div className="flex flex-col justify-center items-center">
        ...
        <Button className='my-1 px-4 rounded-xl'variant={"secondary"}><PencilSquareIcon className='mr-2' width={"25"}/> EDITAR</Button>
      </div>
      <div className="self-end col-span-2 py-10 ">
        <h1 className="text-3xl font-bold text-white ">Username value</h1>
